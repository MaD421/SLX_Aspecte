...
public class MessageViewController {
    ...
    @Autowired
    public MessageViewController(CustomUserDetailsService customUserDetailsService) {
        this.customUserDetailsService = customUserDetailsService;
    }

    @GetMapping("/user/{partnerId}/messages")
    public String viewWithUser(@PageableDefault(value = messagesPerPage) Pageable page, Model model, @PathVariable Long partnerId, HttpServletResponse response) {
    ...
    @GetMapping("/inbox")
    public String inbox(@PageableDefault(value = inboxMessagesPerPage) Pageable page, Model model) {
